...
export default function MeetingScreen() {
  ...
  const renderMeetingItem = ({ item }: { item: Meeting }) => (
    <View className="bg-white border border-gray-100 p-4 mb-3 flex-row items-center justify-between shadow-sm">
  ...
  return (
    <View className="flex-1 bg-[#F8F9FE]">
      {/* Header */}
      <View
        className="flex-row items-center justify-between px-4 py-4 pt-8 mb-4 bg-white border-b border-b-gray-200"
